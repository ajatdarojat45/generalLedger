...
<form name="frm_setup_akun_jurnal" class="form-inline" role="form" method="POST" >
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="row">
			...
			<div class="col-xs-6 text-right">
				...
				<button class="btn btn-success " type="button" name="btn-save-setup" id="btn-save" onClick="klik_save();"><span class="glyphicon glyphicon-ok"></span></button>
	...
	?>
		...
		<table border="0" align="center">
			...
			<button class="btn btn-success" type="button" name="btn-kas-reset" id="btn-kas-r" onClick="klik_reset(1);"> <span class="glyphicon glyphicon-trash"></span> </button> <button class="btn btn-success" type="button" name="btn-kas" id="btn-kas"><span class="glyphicon glyphicon-search"></span></button> </p><br/><td></tr>
			<tr><td>
			...
			<button class="btn btn-success" type="button" name="btn-bank-reset" id="btn-bank-r" onClick="klik_reset(2);"><span class="glyphicon glyphicon-trash"></span></button> <button class="btn btn-success" type="button" name="btn-bank" id="btn-bank"><span class="glyphicon glyphicon-search"></span></button> </p><br/></td></tr>
			<tr><td>
			...
			<button class="btn btn-success" type="button" name="btn-bs-reset" id="btn-bs-r" onClick="klik_reset(3);"><span class="glyphicon glyphicon-trash"></span></button> <button class="btn btn-success" type="button" name="btn-bs" id="btn-bs"><span class="glyphicon glyphicon-search"></span></button> </p></td></tr>
		</table><br/>	
</div>
