<?php
	...
	if ($_POST[c_address]<>$user_log && !empty($user_id) ) {
		...
		echo "<script> alert('$user_id aktif dari lokasi lain anda harus login ulang. <br>Silahkan logout dahulu !'); </script>";
		...
		//echo "<meta http-equiv='refresh' content='0; url=../../../glt/'>";
		exit(0);	
	}
?>