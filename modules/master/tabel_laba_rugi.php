...
<form name="frm_neraca" method="POST">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">    
            <div class="row">
                <div class="col-xs-4"><p class="panel-title"><span class='glyphicon glyphicon-book'></span> TABEL LABA RUGI <span class="badge alert-warning" id="badge_kode"><? echo "$kode"; ?></span><span class="badge alert-warning" id="badge_nama"><? echo "$nama"; ?></span></p>
                </div>            
