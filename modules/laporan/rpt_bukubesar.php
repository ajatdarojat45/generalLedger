...
<div class="navbar navbar-default navbar-form" role="navigation">
	<div class="navbar-header"><h4 class="text-danger"> LAPORAN BUKU BESAR </h4>
...
<div class="row">
	<div class="col-md-12">
		<div class=" form-inline alert-warning ">
			...
			Kode Akun : <input id="acc1" class="easyui-combobox" name="pil_acc" style="width:130px;"  
					data-options="valueField:'acc',textField:'acc',url:'../trans/get_akun_kode_list.php',
					onSelect: function(rec){ $('#acc2').combobox('setValue', rec.acc); }"/>
					
			<input id="acc2" class="easyui-combobox" name="pil_nmp" style="width:350px;"  
					data-options="valueField:'acc',textField:'nmp',url:'../trans/get_akun_name_list.php',
...
<div class="mp_content_laporan">
	...
	<script src="aksi_bukubesar.js"></script>
</BODY>
</HTML>
<!-- session -->
<?	
