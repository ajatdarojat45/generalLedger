...
{	var laporan=$("#rpt-sel").val();
	...
	var acc=$("#acc1").combobox('getValue');

	if (acc=="") {
		$.messager.alert('Perhatian','Kode Akun Tidak Boleh Kosong !','info');
		return  ;
	}
	$("#area_isian").html("");
	...
	alert(laporan+"&id_menu="+idmenu+"&per_thn="+per_thn+"&per_bln="+per_bln+"&acc="+acc);
	
	document.getElementById("frame_pdf").src = laporan+"&id_menu="+idmenu+"&per_thn="+per_thn+"&per_bln="+per_bln+"&acc="+acc;
