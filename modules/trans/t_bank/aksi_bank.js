...
function klik_add()
{
	...
	document.getElementById("no_bukti").value="BK";
	...
	var v_get="trans_bank_reset_detail.php?kode_reset=New";
...
{	
	...
	if (trans_detail=="Add") {
		var v_get="trans_bank_save_detail.php?add_detail=true&no_bukti="+v_nbk+"&seq="+d_seq+"&tipe="+v_tipe+"&txt_tglbukti="+v_tgp;
	} else {
		var v_get="trans_bank_save_detail.php?edit_detail=true&no_bukti="+v_nbk+"&seq="+d_seq+"&tipe="+v_tipe+"&txt_tglbukti="+v_tgp;
	}

	$.post(v_get,$("#frm_bank").serialize(),function(data) {
...
function klik_row_delete(kode,nama_id)
{
	...
	var v_get="trans_bank_save_detail.php?delete_detail=true&no_bukti="+v_nbk+"&seq="+d_seq+"&tipe="+v_tipe+"&txt_tglbukti="+v_tgp;
...
{	
	...
	var v_get="trans_bank_reset_detail.php?kode_reset="+isi_badge;
...
function klik_find()
{
	...
	$("#tombol-find").bind("click", function(event) {
		...
		var url="trans_cari.php?jenis_trans=Bank&btn_go_find=true";
...
{	
	if (kode==1) {
		...
		var url="tabel_cari_akun.php?btn_go_find=true";
	} else {
		var ket="Cari Akun Detail";
		var url="tabel_cari_akun_detail.php?btn_go_find=true";
	} 
