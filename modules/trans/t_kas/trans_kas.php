...
<body>
	...
	<div id="lo" class="easyui-layout" style="width:100%;height:540px;">
		<div data-options="region:'center',title:'JURNAL KAS KELUAR / MASUK',split:true,href:'trans_kas_form.php'" style="padding:5px 5px 5px 5px;border:0px"></div>
		<div data-options="region:'east',title:'Tabel Data Transaksi',split:true,href:'trans_kas_tabel.php'" style="width:450px;padding:5px"></div>
	</div>	
