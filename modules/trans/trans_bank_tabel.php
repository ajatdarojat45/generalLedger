...
if (isset($_SESSION['app_glt'])) {
	...
	echo "<script>window.localStorage.setItem('_acc2','$acc')</script>";
	echo "<script>window.localStorage.setItem('_nmp2','$nmp')</script>";
	
?>
	
	<table id="dg" class="easyui-datagrid" title="" style="width:100%;height:96%;padding:0px;"
			data-options="rownumbers:true,singleSelect:true,url:'get_trans.php?tipe=B',pagination:true,pageSize:50,pageList:[50,100,250,500,1000,2000],
	...
	<div id="dlg-induk" class="easyui-dialog" style="width:80%;padding:10px 10px" 
            closed="true" buttons="#btn-induk" modal="true" draggable="true" title="Transaksi Jurnal Kas"> 
				...
				<tr height="30px">
					...
					<td>
						<input id="tipetrans1" name="tipetrans1" class="easyui-switchbutton" value='off' 
							data-options="onText:'Penerimaan Bank',offText:'Pengeluaran Bank',width:'150px',
							onChange:function(checked){	
								if (document.getElementById('autonumber1').checked==false){
									if (checked){
										$('#nbk1').textbox('setValue','BM');										
									} else {
	...
	<div id="dlg-detail" class="easyui-dialog" style="padding:10px 20px"
            closed="true" buttons="#btn-detail" modal="true" draggable="true" title="Detail Transaksi Jurnal Kas"> 			
	...
	<div id="dlg-cetak" class="easyui-dialog" style="width:70%;height:80%;padding:10px 20px"
            closed="true" buttons="#dlg-btn-cetak" modal="true" maximizable="true" draggable="true" title="Transaksi Jurnal Bank"> 
