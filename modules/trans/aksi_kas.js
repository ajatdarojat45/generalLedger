...
function doAdd()
{
	...
	acc=window.localStorage.getItem('_acc1');
	nmp=window.localStorage.getItem('_nmp1');
...
{	
	...
	$('#dlg-induk').dialog('open').dialog('setTitle','Jurnal Kas Nomor : '+nbk);
	$('#dlg-induk').dialog('center');	
	$('#fm').form('clear');
...
function doPrint()
{
	...
	document.getElementById('frame_pdf').src="cetak_jurnal.php?tipe=K&nbk="+nbk;			
