...
if (isset($_SESSION['app_glt'])) {
	...
	echo "<script>window.localStorage.setItem('_acc3','$acc')</script>";
	echo "<script>window.localStorage.setItem('_nmp3','$nmp')</script>";
	
?>
	
	<table id="dg" class="easyui-datagrid" title="" style="width:100%;height:96%;padding:0px;"
			data-options="rownumbers:true,singleSelect:true,url:'get_trans.php?tipe=S',pagination:true,pageSize:50,pageList:[50,100,250,500,1000,2000],
	...
	<div id="dlg-induk" class="easyui-dialog" style="width:80%;padding:10px 10px" 
		...
		<form id="fm" method="post"> <!--novalidate-->
			<table width="100%">
				...
				<tr height="30px">
					...
					<td>
						<input id="tipetrans1" name="tipetrans1" class="easyui-switchbutton" value='off' 
							data-options="onText:'Penyelesaian BS',offText:'Pengeluaran BS',width:'150px',
				...
				<tr height="30px">
					<td align="right"> <label>Akun Pusat BS : &nbsp;&nbsp; </label> </td>
					<td>
	...
	<div id="dlg-cetak" class="easyui-dialog" style="width:70%;height:80%;padding:10px 20px"
            closed="true" buttons="#dlg-btn-cetak" modal="true" maximizable="true" draggable="true" title="Transaksi Jurnal BS"> 
