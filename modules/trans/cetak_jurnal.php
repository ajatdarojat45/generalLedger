<?php
	...
	$qry1="select * from ".$tbl_trx." where nbk='$nbk' and trx_status='1' and typ='$tipe' order by nbk,seq ";
	$rs1 = mysql_query($qry1,$conn) or die ("Error $qry ".mysql_error());
	$rec1=mysql_fetch_array($rs1);
	
	$qry2="select * from ".$tbl_trx." where nbk='$nbk' and trx_status='1' and typ='$tipe' order by nbk,seq ";
